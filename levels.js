...
const Levels = {
    ...
    loadLevel(chapter, levelIndex) {
        ...
        Obstacles.obstacleSpawnInterval = Math.max(40, 80 / this.currentLevelData.obstacleDensity);
        Obstacles.coinSpawnInterval = Math.max(20, 40 / this.currentLevelData.obstacleDensity);
    },
